...
def run(
  ...
  table = pd.read_sql(
    f"""
        ...
        LEFT JOIN
            [relationship] [r]
            ON [r].[account_code] = [t].[account_code]
        LEFT JOIN
            [branch] [b]
  ...
  file_name = 'Báo cáo phái sinh theo dõi TKKH cần chuyển tiền từ VSD về TKGD.xlsx'
  ...
  worksheet.insert_image('A1','./img/phs_logo.png',{'x_scale':0.58,'y_scale':0.66})
