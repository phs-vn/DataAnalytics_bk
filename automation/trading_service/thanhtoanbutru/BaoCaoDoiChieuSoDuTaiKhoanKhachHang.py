    ...
    def wrapper(*args, **kwargs):
        ...
        if not abnormalTable.empty:
            ...
            abnormalTable = abnormalTable.rename(columns={
                ...
                'opening_balance_t1': 'Số dư tiền đầu ngày T-1 tại Flex',
                'closing_balance_t1': 'Số dư tiền cuối ngày T-1 tại Flex',
                'opening_balance_t0': 'Số dư tiền đầu ngày T0 tại Flex',
                'opening_balance_t1_ref': 'Số dư tiền đầu ngày T-1 lưu ngoài Flex',
                'closing_balance_t1_ref': 'Số dư tiền cuối ngày T-1 lưu ngoài Flex',
                'check': 'Bất thường',
            ...
            mail.Subject = f"Dữ liệu bất thường Báo cáo Đối chiếu số dư tiền TKKH {dt.datetime.now().strftime('%d.%m.%Y')}"
...
def run(
    ...
    # saved_folder = join(r'D:\DataAnalytics\automation\trading_service\thanhtoanbutru\sodutientaikhoankhachhang')
