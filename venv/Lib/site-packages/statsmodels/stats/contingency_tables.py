...
class Table2x2(SquareTable):
    ...
    Note that for the risk_management ratio, the analysis is not symmetric with
    ...
    def riskratio(self):
        """
        Returns the risk_management ratio for a 2x2 table.

        The risk_management ratio is calculated with respect to the rows.
        """
    ...
    def log_riskratio(self):
        """
        Returns the log of the risk_management ratio.
        """
    ...
    def log_riskratio_se(self):
        """
        Returns the standard error of the log of the risk_management ratio.
        """
    ...
    def riskratio_pvalue(self, null=1):
        """
        p-value for a hypothesis test about the risk_management ratio.

        Parameters
        ----------
        null : float
            The null value of the risk_management ratio.
        """
    ...
    def log_riskratio_pvalue(self, null=0):
        """
        p-value for a hypothesis test about the log risk_management ratio.

        Parameters
        ----------
        null : float
            The null value of the log risk_management ratio.
        """
    ...
    def log_riskratio_confint(self, alpha=0.05, method="normal"):
        """
        A confidence interval for the log risk_management ratio.
    ...
    def riskratio_confint(self, alpha=0.05, method="normal"):
        """
        A confidence interval for the risk_management ratio.
...
class StratifiedTable(object):
    ...
    def riskratio_pooled(self):
        """
        Estimate of the pooled risk_management ratio.
        """
    ...
    def summary(self, alpha=0.05, float_format="%.3f", method="normal"):
        ...
        stubs = ["Pooled odds", "Pooled log odds", "Pooled risk_management ratio", ""]
