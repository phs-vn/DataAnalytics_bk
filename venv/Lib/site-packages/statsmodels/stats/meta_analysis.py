...
def effectsize_2proportions(count1, nobs1, count2, nobs2, statistic="diff",
    ...
    statistic : {"diff", "odds-ratio", "risk_management-ratio", "arcsine"}
        statistic for the comparison of two proportions
        Effect sizes for "odds-ratio" and "risk_management-ratio" are in logarithm.
    ...
    The statistics are defined as:
     ...
     - risk_management difference = p1 - p2
     - log risk_management ratio = log(p1 / p2)
    ...
    log-odds-ratio and log-risk_management-ratio can be transformed back to ``or`` and
    ...
    if statistic in ["diff", "rd"]:
        ...
        eff = rd
        var_eff = rd_var
    elif statistic in ["risk_management-ratio", "rr"]:
        # rr = p1 / p2
