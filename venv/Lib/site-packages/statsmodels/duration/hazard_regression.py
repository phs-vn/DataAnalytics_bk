...
class PHSurvivalTime(object):
    ...
    def __init__(self, time, status, exog, strata=None, entry=None,
        ...
        entry : array_like
            ...
            part of the risk_management set for times before the entry time.  If
        ...
        # enter the risk_management set at the k^th sorted unique failure time in
        # stratum stx
        #
        # risk_exit[stx][k] is a list of indices for subjects who exit
        # the risk_management set at the k^th sorted unique failure time in
        # stratum stx
        ...
        for stx in range(self.nstrat):
            ...
            # risk_management set at each unique failure time.
...
class PHReg(model.LikelihoodModel):
    ...
    def breslow_loglike(self, params):
        ...
        for stx in range(surv.nstrat):
            ...
            for i in range(nuft)[::-1]:
                ...
                # Update for new cases entering the risk_management set.
                ...
                # Update for cases leaving the risk_management set.
    ...
    def weighted_covariate_averages(self, params):
        ...
        subjects who are at-risk_management at a particular time.
        ...
        averages : list of ndarrays
            ...
            average values (for all the covariates) of at-risk_management
...
class PHRegResults(base.LikelihoodModelResults):
    ...
    def weighted_covariate_averages(self):
        """
        The average covariate values within the at-risk_management set at each
    ...
    def schoenfeld_residuals(self):
        ...
        for stx in range(surv.nstrat):
            ...
            # their stratum, so have empty risk_management sets and undefined
            # residuals.
