...
def _secure_headers(headers, hdr_validation_flags):
    """
    Certain headers are at risk_management of being attacked during the header compression
    ...
    These fields are the most at-risk_management. These rules are inspired by Firefox
    and nghttp2.
    """
