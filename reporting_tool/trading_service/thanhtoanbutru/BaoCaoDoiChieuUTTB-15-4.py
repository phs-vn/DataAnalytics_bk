...
def run(
    ...
    # merge row
    sheet_bao_cao_can_lam.merge_range('C1:G1', CompanyName, company_name_format)
    sheet_bao_cao_can_lam.merge_range('C2:G2', companyAddress, company_format)
    sheet_bao_cao_can_lam.merge_range('C3:G3', CompanyPhoneNumber, company_format)
