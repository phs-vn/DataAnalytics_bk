...
# DONE
def run(): # BC này chỉ chạy được thời điểm hiện tại (chạy lúc đầu tháng)
    ...
    def get_individual(account_type):
    ...
    instituional = get_individual('institutional')
    individual = get_individual('individual')
