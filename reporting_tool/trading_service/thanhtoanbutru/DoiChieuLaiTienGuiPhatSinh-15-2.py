...
def run(
    ...
    end_date = dt.datetime(end_date, "%Y/%m/%d").strftime("%d-%m")
    f_name = ''
    if start_date == end_date:
        f_name += f'Báo cáo đối chiếu lãi tiền gửi phát sinh trên tài khoản khách hàng {end_date}.xlsx'
    else:
        f_name += f'Báo cáo đối chiếu lãi tiền gửi phát sinh trên tài khoản khách hàng từ {start_date} đến {end_date}.xlsx'
    ...
    sheet_bao_cao_can_lam.set_column('D:D', 15.57)
    sheet_bao_cao_can_lam.set_column('E:E', 17.43)
    sheet_bao_cao_can_lam.set_column('F:F', 17.43)
    sheet_bao_cao_can_lam.set_column('G:G', 29)
    sheet_bao_cao_can_lam.set_column('H:H', 14.14)
    sheet_bao_cao_can_lam.set_column('I:I', 17.71)
    sheet_bao_cao_can_lam.set_column('J:J', 15.86)
